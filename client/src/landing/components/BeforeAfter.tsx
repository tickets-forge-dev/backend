...
const slackMessages = [
  ...
  { name: 'Jordan', initials: 'JR', color: '#4a9eff', text: '🙃', time: '1:16 PM' },
];
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-3">
            <div
              className="rounded-xl border border-[var(--border-subtle)] overflow-hidden animate-fade-in"
              style={{ animationDelay: '100ms', animationFillMode: 'both' }}
            >
              {/* Slack header */}
              <div className="flex items-center gap-2 px-4 py-2.5 border-b border-[var(--border-subtle)] bg-[rgba(255,255,255,0.02)]">
                <span className="text-sm font-semibold text-[var(--text)]"># dev-backend</span>
              ...
              <div className="px-4 py-3 flex flex-col gap-2.5 max-h-[420px] overflow-y-auto">
                {slackMessages.map((msg, i) => {
                  ...
                  const isTimeSeparator = msg.time === '1:14 PM' && prevMsg?.time === '11:06 AM';
                  return (
                    <div key={i}>
                      {isTimeSeparator && (
                        <div
                          className="flex items-center gap-3 my-2 animate-fade-in"
                          style={{
            ...
            {/* Before label */}
            <div
              className="flex items-center gap-2 px-1 animate-fade-in"
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              {/* Spec header */}
              <div className="flex items-center gap-2 px-4 py-2.5 border-b border-[var(--border-subtle)] bg-[rgba(255,255,255,0.02)]">
                <span className="text-sm font-semibold text-[var(--text)]">Forge Spec</span>
                <span className="ml-auto inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                  95 / 100
                </span>
              </div>
              ...
              <div className="px-4 py-4 flex flex-col gap-4">
                ...
                >
                  <h4 className="text-base font-semibold text-[var(--text)] mb-1">
                    {specSections.title}
                  </h4>
