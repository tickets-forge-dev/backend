    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-1.5">
        <input
          ...
          className="flex-1 h-8 rounded-md border border-zinc-700 bg-zinc-800/50 px-2.5 text-xs text-[var(--text)] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:ring-1 focus:ring-[var(--blue)] disabled:opacity-40"
        />
        <button
          type="button"
          onClick={handleAdd}
      ...
      {url.trim() && (
        <input
          ...
          onKeyDown={(e) => e.key === 'Enter' && (e.preventDefault(), handleAdd())}
          className="w-full h-8 rounded-md border border-[var(--border-subtle)] bg-zinc-800/50 px-2.5 text-xs text-[var(--text)] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:ring-1 focus:ring-[var(--blue)]"
        />
      )}
