...
- Run tests after making changes. Fix failures.
...
Custom E2B template (`forge-dev`) with Claude Code pre-installed:
...
Weekly GitHub Actions workflow bumps the version and rebuilds the template.
