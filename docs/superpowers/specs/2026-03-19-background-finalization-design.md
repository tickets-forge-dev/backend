...
**Full page layout — panel visible when jobs exist:**
...
│ │                                                    │                     │ │
│ │  ┌────────────────────────────────────────────┐    │  ┌───────────────┐  │ │
│ │  │ 🔹 Add social login          Draft    ···  │    │  │ Add social    │  │ │
│ │  ├────────────────────────────────────────────┤    │  │ login         │  │ │
│ │  │ 🐛 Fix auth redirect         Forged   ···  │    │  │               │  │ │
│ │  ├────────────────────────────────────────────┤    │  │ ● Generating  │  │ │
│ │  │ 🔹 Search redesign           Draft    ···  │    │  │   test plan…  │  │ │
│ │  ├────────────────────────────────────────────┤    │  │               │  │ │
│ │  │ 📋 Update API docs           Complete  ···  │    │  │ ▓▓▓▓▓▓▓░░ 72%│  │ │
│ │  ├────────────────────────────────────────────┤    │  │ 1m 23s        │  │ │
│ │  │ 🔹 Dashboard widgets         Review   ···  │    │  │          [Cancel]│ │
│ │  ├────────────────────────────────────────────┤    │  └───────────────┘  │ │
│ │  │ + New ticket                                │    │                     │ │
│ │  └────────────────────────────────────────────┘    │  ┌───────────────┐  │ │
│ │                                                    │  │ Search        │  │ │
...
┌───────────────────┐        ┌───────────────────┐        ┌───────────────────┐
│ Add social login  │        │ Add social login  │        │ Add social login  │
│                   │        │                   │        │                   │
│ ● Generating      │        │ ✓ Complete        │        │ ✕ LLM timeout     │
│   test plan…      │        │                   │        │                   │
│                   │        │ ▓▓▓▓▓▓▓▓▓ 100%    │        │ ▓▓▓▓▓░░░░  55%   │
│ ▓▓▓▓▓▓▓░░  72%   │        │ 2m 10s            │        │ 1m 47s            │
│ 1m 23s            │        │            [View] │        │           [Retry] │
...
Retrying                     Cancelled (fading out)
┌───────────────────┐        ┌───────────────────┐
│ Add social login  │        │ Add social login  │
│                   │        │     (opacity 0.5)  │
│ ↻ Retrying…       │        │                   │
│   attempt 2/2     │        │ — Cancelled        │
│                   │        │                   │
│ ▓▓░░░░░░░  15%   │        │                   │
│ 0m 08s            │        │                   │
│           [Cancel]│        └───────────────────┘
...
│ │  └────────────────────────────────────────────────────────────────────┘   │ │
│ │                                                                          │ │
│ │  (no jobs panel — full width for tickets)                                │ │
│ │                                                                          │ │
│ └──────────────────────────────────────────────────────────────────────────┘ │
└──────────────────────────────────────────────────────────────────────────────┘
```

**Mobile — collapsed badge + expanded bottom sheet:**

```
Collapsed (badge):                  Expanded (bottom sheet):
┌──────────────────────┐            ┌──────────────────────┐
...
└──────────────────────┘            │  │ 0m 31s    [Cancel]││
  ...
  Floating badge,                   └──────────────────────┘
  bottom-right,
  tap to expand                     Slides up from bottom
```
